...
write_nginx_proxy_config "$APP_NAME" "$N8N_DOMAIN" 5678
...
# Request SSL certificate and update Nginx with SSL config
log_step "Step 12: SSL Certificate"
setup_ssl_certificate "$N8N_DOMAIN" "$N8N_EMAIL" "$APP_NAME" 5678
echo ""
